...
abstract class ObjectRelation extends Relation {
	...
	/**
	 * The foreign key of the parent (entity) model
	 *
	 * @var string
	 */
	protected $entityKey;
	...
	/**
	 * The associated key of the relation (attribute)
	 *
	 * @var string
	 */
	...
	/**
	 * The name field of the parent (entity) model
	 *
	 * @var string
	 */
	protected $entityNameField;

	/**
	 * The name field of the related (attribute) model
	 *
	 * @var string
	 */
	protected $attributeNameField;

	/**
	 * The attribute ids on which to perform the join
	 *
	 * @var array
	 */
	 ...
	 * @param  string  $entityNameField
	 * @param  string  $attributeNameField
	 ...
	 * @param  array  $columns
	 *
	 * @return \Monger\EloquentEAV\Model|static
	 *
	 ...
	 *
	 * @param  \Monger\EloquentEAV\Model  $model
	 *
	 * @return array
	 */
	...
	public function getRelationCountQueryForSelfJoin(Builder $query, Builder $parent)
	{
		...
		return $query->where($hash.'.'.$this->entityKey, '=', new \Illuminate\Database\Query\Expression($key));
	}
